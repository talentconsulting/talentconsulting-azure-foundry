"""Responses-protocol host for the OpenAPI specification generator."""
...
def error_response(error: Exception) -> dict[str, object]:
    if isinstance(error, GenerationError):
        ...
        message = "The OpenAPI specification could not be generated."
...
async def handle_create(
    ...
    try:
        ...
        logger.exception("OpenAPI specification generation failed.")
