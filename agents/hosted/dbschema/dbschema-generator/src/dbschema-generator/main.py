"""Responses-protocol host for the database-schema generator."""
...
def error_response(error: Exception) -> dict[str, object]:
    if isinstance(error, GenerationError):
        ...
        message = "The database schema could not be generated."
...
async def handle_create(
    ...
    try:
        ...
        logger.exception("Database-schema generation failed.")
