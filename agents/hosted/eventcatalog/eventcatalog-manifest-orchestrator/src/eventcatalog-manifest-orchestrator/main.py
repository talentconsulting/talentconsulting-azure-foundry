"""Responses-protocol host for manifest-driven event-and-command-catalog generation."""
...
WORKFLOW_NAME = os.getenv("EVENTCATALOG_WORKFLOW_AGENT_NAME", "eventcatalog-workflow")
PUBLISHER_NAME = os.getenv("EVENTCATALOG_PR_CREATOR_AGENT_NAME", "eventcatalog-pr-creator")
MAX_ENTRIES = int(os.getenv("EVENTCATALOG_MANIFEST_MAX_ENTRIES", "25"))
