...
# project_dir is required: `azd ai agent invoke <name>` resolves <name> against the
# azure.yaml in the current working directory, not just the Foundry project endpoint.
