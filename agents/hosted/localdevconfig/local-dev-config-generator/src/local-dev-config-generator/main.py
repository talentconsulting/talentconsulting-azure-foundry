"""Responses-protocol host for the local-dev-config generator."""
...
def error_response(error: Exception) -> dict[str, object]:
    if isinstance(error, GenerationError):
        ...
        message = "The local development configuration catalog could not be generated."
...
async def handle_create(
    ...
    try:
        ...
        logger.exception("Local-dev-config generation failed.")
