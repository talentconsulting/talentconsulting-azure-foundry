"""Responses host for deterministic .NET version source discovery."""
...
async def handle_create(request: CreateResponse, context: ResponseContext, cancellation_signal: asyncio.Event):
    ...
    try:
        ...
        logger.exception(".NET version source discovery failed.")
        result = {"dotnetVersionFiles": [], "excludedFiles": []}
