...
The upstream hosted `openapi-spec-workflow-hosted` returns one generated specification per API discovered by `talent-openapi-file-scan`. This agent receives one generated spec item at a time and returns a structured review result.
