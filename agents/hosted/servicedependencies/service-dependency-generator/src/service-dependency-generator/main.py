"""Responses-protocol host for the service-dependency generator."""
...
def error_response(error: Exception) -> dict[str, object]:
    if isinstance(error, GenerationError):
        ...
        message = (str(error).strip() or "The service-dependency catalog could not be generated.")[:300]
...
async def handle_create(request: CreateResponse, context: ResponseContext, cancellation_signal: asyncio.Event):
    ...
    try:
        ...
        logger.exception("Service-dependency generation failed.")
