"""Responses-protocol host for the event-and-command-catalog generator."""
...
def error_response(error: Exception) -> dict[str, object]:
    if isinstance(error, GenerationError):
        ...
        message = (detail or "The event and command catalog could not be generated.")[:300]
...
async def handle_create(
    ...
    try:
        ...
        logger.exception("Event-and-command-catalog generation failed.")
