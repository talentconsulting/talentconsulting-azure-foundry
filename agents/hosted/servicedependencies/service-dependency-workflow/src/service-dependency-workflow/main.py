"""Responses host for service-dependency workflow orchestration."""
...
DISCOVERY_NAME = os.getenv("SERVICE_DEPENDENCY_DISCOVERY_AGENT_NAME", "service-dependency-source-discovery")
GENERATOR_NAME = os.getenv("SERVICE_DEPENDENCY_GENERATOR_AGENT_NAME", "service-dependency-generator")
