"""Responses host for manifest-driven repo-metadata generation."""
...
WORKFLOW_NAME = os.getenv("REPO_METADATA_WORKFLOW_AGENT_NAME", "repo-metadata-workflow")
PUBLISHER_NAME = os.getenv("REPO_METADATA_PR_CREATOR_AGENT_NAME", "repo-metadata-pr-creator")
MAX_ENTRIES = int(os.getenv("REPO_METADATA_MANIFEST_MAX_ENTRIES", "25"))
MAX_CATALOGS = int(os.getenv("REPO_METADATA_MANIFEST_MAX_CATALOGS", "100"))
...
async def handle_create(request: CreateResponse, context: ResponseContext, cancellation_signal: asyncio.Event):
    ...
    try:
        ...
        logger.exception("Manifest-driven repo-metadata orchestration failed.")
