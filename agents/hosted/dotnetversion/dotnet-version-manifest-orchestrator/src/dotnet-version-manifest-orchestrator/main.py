"""Responses host for manifest-driven dotnet-version generation."""
...
WORKFLOW_NAME = os.getenv("DOTNET_VERSION_WORKFLOW_AGENT_NAME", "dotnet-version-workflow")
PUBLISHER_NAME = os.getenv("DOTNET_VERSION_PR_CREATOR_AGENT_NAME", "dotnet-version-pr-creator")
MAX_ENTRIES = int(os.getenv("DOTNET_VERSION_MANIFEST_MAX_ENTRIES", "25"))
MAX_CATALOGS = int(os.getenv("DOTNET_VERSION_MANIFEST_MAX_CATALOGS", "100"))
...
async def handle_create(request: CreateResponse, context: ResponseContext, cancellation_signal: asyncio.Event):
    ...
    try:
        ...
        logger.exception("Manifest-driven dotnet-version orchestration failed.")
