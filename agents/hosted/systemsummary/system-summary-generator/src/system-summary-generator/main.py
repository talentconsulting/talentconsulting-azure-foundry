"""Responses-protocol host for the system-summary generator."""
...
def error_response(error: Exception) -> dict[str, object]:
    if isinstance(error, GenerationError):
        ...
        message = (str(error).strip() or "The system summary could not be generated.")[:300]
...
async def handle_create(request: CreateResponse, context: ResponseContext, cancellation_signal: asyncio.Event):
    ...
    try:
        ...
        logger.exception("System-summary generation failed.")
